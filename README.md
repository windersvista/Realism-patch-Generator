...
**EFT 现实主义数值生成器 v2.11** 是一个功能强大的Python脚本，用于为《逃离塔科夫》(Escape from Tarkov)的 SPT3.11.4 现实主义 MOD (Realism Mod) 自动重建并生成数值配置。它可以根据 `input/` 文件夹中的物品数据，使用预定义模板快速生成规范化配置文件。
