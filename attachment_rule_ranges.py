...
MOD_PROFILE_RANGES = {
    ...
    "muzzle_suppressor_compact": {
        ...
        "CameraRecoil": (-3, -1),
        "VerticalRecoil": (-8, -3),
        "HorizontalRecoil": (-6, -1),
        "Dispersion": (-1, 1),
        "Accuracy": (-3, 5),
        "Velocity": (0, 2),
        "Loudness": (-20, 10),
        "Flash": (-45, -10),
        "ModMalfunctionChance": (4, 18),
        "DurabilityBurnModificator": (1.0, 1.75),
        "AimSpeed": (-10, -2),
    },
    "muzzle_flashhider": {
        "Ergonomics": (-5, -2),
    ...
    "catch": {
        "ModMalfunctionChance": (-1, 1),
    },
    "hammer": {
        "ModMalfunctionChance": (-2, 2),
        "Ergonomics": (-1, 2),
    },
    "trigger": {
        "ModMalfunctionChance": (-1, 2),
    ...
    "barrel_integral_suppressed": {
        "VerticalRecoil": (-14, -8),
        "HorizontalRecoil": (-8, -5),
        "Dispersion": (-5, 0),
        "Velocity": (-3, 3),
        "Accuracy": (-5, 5),
        "HeatFactor": (1.05, 1.25),
        "CoolFactor": (1.0, 1.08),
        "DurabilityBurnModificator": (1.15, 1.35),
    },
    "barrel_long": {
        "VerticalRecoil": (-6, -3),
